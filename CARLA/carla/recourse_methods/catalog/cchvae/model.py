...
class CCHVAE(RecourseMethod):
    ...
    - Hyperparams
        ...
        * "vae_params": Dict
            ...
            + "layers": list with number of neurons per layer.
    ...
    def _load_vae(
        ...
        generative_model = VariationalAutoencoder(
            data_name, vae_params["layers"], mlmodel.get_mutable_mask(), save_to=vae_params['save_to']
        )
        ...
        if vae_params["train"]:
            ...
            try:
                generative_model.load(vae_params["layers"][0], load_from=vae_params["weights_path"])
