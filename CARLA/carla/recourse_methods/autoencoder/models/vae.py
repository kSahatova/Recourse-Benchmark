...
class VariationalAutoencoder(nn.Module):
    def __init__(self, data_name: str, layers: List, mutable_mask, save_to: str):
        """
        ...
        save_to:
            Path to the weights of the trained VAE.
        """
    ...
    def load(self, input_shape, load_from):
        cache_path = get_home(models_home=load_from)
    ...
    def save(self):
        cache_path = get_home(models_home=self.save_to)
